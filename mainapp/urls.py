...
urlpatterns = [
    ...
    url(
        r"request_details/(?P<request_id>\d+)/$",
    ...
    url(
        r"collection_centers/(?P<location>\w+)/$",
    ...
    path(
        "login/",
        auth_views.LoginView.as_view(template_name="mainapp/login.html"),
        name="user_login",
    ),
    ...
    path(
        "camp/<int:pk>/requirements/",
        views.CampRequirements.as_view(),
        name="camp_requirements",
    ),
    path("camp/<int:pk>/details/", views.CampDetails.as_view(), name="camp_details"),
    path(
        "camp/<int:camp_id>/add_person/", views.AddPerson.as_view(), name="add_person"
    ),
    ...
    path(
        "announcements/<str:filter_>",
        views.announcements_filter,
        name="announcements_filter",
    ),
    path(
        "camp_requirements/",
        views.camp_requirements_list,
        name="camp_requirements_list",
    ),
    path(
        "submission_success/",
        views.SubmissionSuccess.as_view(),
        name="submission_success",
    ),
    url(
        r"request_update/(?P<request_id>\d+)/$",
        views.RequestUpdateView.as_view(),
        name="requestupdateview",
    ),
    path(
        "req_update_success/",
        views.ReqUpdateSuccess.as_view(),
        name="req_update_success",
    ),
    path("consent_success/", views.ConsentSuccess.as_view(), name="consent_success"),
    url(
        r"c/(?P<pk>\d+)/(?P<ts>\d+)/$",
        views.VolunteerConsent.as_view(),
        name="volunteer_consent",
    ),
    url(
        "missing_and_finding_persons/",
        views.ReportFindPerson.as_view(),
        name="report_find_person",
    ),
