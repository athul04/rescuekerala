...
class TemplateViewTests(TestCase):
    ...
    def test_loading_relief_camps_view(self):
        self.check_template_view_response("/relief_camps/", "mainapp/relief_camps.html")
...
class ReliefCampsListTest(TestCase):
    ...
    def test_loading_blank_page(self):
        ...
        self.assertIn('select name="district"', str(response.context["filter"].form))
    ...
    def test_validation_errors_in_query(self):
        ...
        self.assertTemplateUsed(response, "mainapp/relief_camps_list.html")
        self.assertIn(
            "Select a valid choice. ernakulam is not one of the available choices.",
