...
class ModelTest(TestCase):
    ...
    def test_contributor_string_representation(self):
        ...
        self.assertEqual(
            str(contributor),
            contributor.name + " " + contributor.get_district_display(),
        )
    ...
    def test_district_manager_string_representation(self):
        ...
        self.assertEqual(
            str(districtManager),
            districtManager.name + " " + districtManager.get_district_display(),
        )

    def test_district_need_string_representation(self):
        districtNeed = DistrictNeed(
            district="tvm", needs="Clothes, Water", cnandpts="HDFC bank"
        )
    ...
    def test_district_collection_string_representation(self):
        districtCollection = DistrictCollection(
            district="pkd", collection="Clothes, Utensils"
        )
        self.assertEqual(
            str(districtCollection), districtCollection.get_district_display()
        )
